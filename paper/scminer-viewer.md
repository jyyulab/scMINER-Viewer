...
![Figure 1A](figures/figure1_A_size_vs_cells.pdf){width=70%}
![Figure 1B](figures/figure1_B_load_latency.pdf){width=70%}
![Figure 1C](figures/figure1_C_fetch_latency.pdf){width=70%}
![Figure 1D](figures/figure1_D_discover_scaling.pdf){width=70%}
![Figure 1E](figures/figure1_E_prepare_time.pdf){width=70%}
![Figure 1F](figures/figure1_F_peak_memory.pdf){width=70%}
...
sparse expression matrix. Generated by `paper/benchmarks/figures.R`; raw numbers
at `paper/metrics/*.tsv`. Table 2 (`paper/tables/figure1_scaling.md`)
lists per-configuration metrics for the 28 grid points underlying
panels A, B, C, E, F. Table 1 (`paper/tables/portal_studies.md`)
gives the same panel-by-panel breakdown for the 26 real portal
studies whose figures are at `paper/figures/figure_portal_*.{pdf,png}`.
