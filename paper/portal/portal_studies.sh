#!/usr/bin/env bash
# paper/portal/portal_studies.sh
#
# Convenience wrapper for paper/portal/portal_studies.R. Use this when running
# directly (no scheduler) on an HPC interactive node or local machine.
# For batch submission on LSF, see paper/portal/portal_studies.bsub.
#
# Usage:
#   ./paper/portal/portal_studies.sh --studies-root /path/to/studies
#   ./paper/portal/portal_studies.sh --studies-root <path> --cap 10000
#   ./paper/portal/portal_studies.sh --studies-root <path> --only Tex,Tregs
#
...
Rscript paper/portal/portal_studies.R "$@" 2>&1 | tee "$LOG"
