#!/usr/bin/env Rscript
# paper/code/benchmarks/figures.R
#
# Runs the synthetic-sweep benchmarks defined in paper/code/benchmarks/methods.R
# against:
...
#   paper/metrics/benchmarks/bundle_scaling.tsv                   per-config rows
#   paper/metrics/benchmarks/discover_scaling.tsv
#   paper/metrics/benchmarks/real_study.tsv                       (if bundle present)
#
...
source("paper/code/benchmarks/methods.R")
...
write.table(scaling, "paper/metrics/benchmarks/bundle_scaling.tsv",
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(scaling_summary, "paper/metrics/benchmarks/bundle_scaling_summary.tsv",
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(discover, "paper/metrics/benchmarks/discover_scaling.tsv",
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(discover_summary, "paper/metrics/benchmarks/discover_scaling_summary.tsv",
            sep = "\t", row.names = FALSE, quote = FALSE)
if (!is.null(real)) {
  write.table(as.data.frame(real, stringsAsFactors = FALSE),
              "paper/metrics/benchmarks/real_study.tsv",
              sep = "\t", row.names = FALSE, quote = FALSE)
}
