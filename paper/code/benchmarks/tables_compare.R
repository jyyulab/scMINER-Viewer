#!/usr/bin/env Rscript
# paper/code/benchmarks/tables_compare.R
#
# Generate two tables from the joined wide TSV produced by
# paper/code/portal/portal_compare.R. Table 1 (the manuscript table for
# the TF/sig-eligible studies) is built by paper/code/benchmarks/tables.R
