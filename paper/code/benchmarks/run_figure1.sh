...
#
#   1.  Rscript paper/code/benchmarks/figures.R     7x4 = 28 configs
#   2.  Rscript paper/code/benchmarks/tables.R      regenerate table 2
#
# Two modes:
#
...
# Usage:
#   ./paper/code/benchmarks/run_figure1.sh
#   ./paper/code/benchmarks/run_figure1.sh --hpc --mem 32000 --wall 4:00
#   ./paper/code/benchmarks/run_figure1.sh --hpc --queue priority --mem 64000
#
...
mkdir -p paper/figures paper/metrics/benchmarks paper/tables paper/logs
