#!/usr/bin/env Rscript
# paper/code/portal/portal_studies.R
#
...
#
# Per-study metrics written to paper/metrics/portal_studies/portal_studies.tsv:
#
...
#   Rscript paper/code/portal/portal_studies.R --studies-root data/input
#   Rscript paper/code/portal/portal_studies.R --studies-root /hpc/.../studies
#   Rscript paper/code/portal/portal_studies.R --studies-root <path> --only 2327
...
out_tsv      <- get_arg("--out", "paper/metrics/portal_studies/portal_studies.tsv")
