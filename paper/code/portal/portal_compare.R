#!/usr/bin/env Rscript
# paper/code/portal/portal_compare.R
#
...
expr_glob <- get_arg("--expr-only-glob",
                      "paper/metrics/portal_studies/portal_studies_*_expression-only.tsv")
full_glob <- get_arg("--full-glob",
                      "paper/metrics/portal_studies/portal_studies_*_full.tsv")
