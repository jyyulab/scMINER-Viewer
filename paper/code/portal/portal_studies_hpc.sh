#!/usr/bin/env bash
# paper/code/portal/portal_studies_hpc.sh
#
...
# the per-study TSVs into paper/metrics/portal_studies/portal_studies.tsv once the
# array has finished.
#
...
#
# Usage:
#   ./paper/code/portal/portal_studies_hpc.sh --configs-dir paper/configs
#   ./paper/code/portal/portal_studies_hpc.sh --studies-root /research/.../studies
#   ./paper/code/portal/portal_studies_hpc.sh --configs-dir <path> --mem 64000 -W 12:00
#   ./paper/code/portal/portal_studies_hpc.sh --configs-dir <path> --queue "standard priority compbio"
#
# Flags:
...
MERGE_CMD='Rscript paper/code/portal/portal_merge.R paper/metrics/portal_studies/portal_studies.tsv paper/metrics/portal_studies/portal_studies_*.tsv'
...
submit_array_for_queue() {
  ...
  if [[ "$DRY_RUN" == "1" ]]; then
    ...
    printf '    %q ' "${cmd[@]}"; echo "< paper/code/portal/portal_studies.bsub"
  else
...
echo
echo "Final merged TSV will appear at paper/metrics/portal_studies/portal_studies.tsv"
