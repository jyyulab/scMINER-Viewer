...
#
# One-time bsub wrapper around paper/code/portal/sparseify_eset.R: converts a
...
Rscript paper/code/portal/sparseify_eset.R ${R_ARGS[*]@Q}
EOF
)"
...
echo "        -i paper/code/configs/<id>.yaml"
