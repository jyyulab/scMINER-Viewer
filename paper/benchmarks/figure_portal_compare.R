#!/usr/bin/env Rscript
# paper/benchmarks/figure_portal_compare.R
#
# Render two figure sets from the joined wide table produced by
# paper/portal/portal_compare.R (paper/metrics/portal_studies_compare.tsv).
# Figure 3 (the full-mode 6-panel figure for the manuscript) is rendered
# by paper/benchmarks/figure_portal.R from the same compare data; this
...
#
# CLI overrides:
#   --compare-tsv <path>  default paper/metrics/portal_studies_compare.tsv
