...
| **Pre-processed bundle** — full 2327 bundle + complete shard tree (every gene). Fastest way to browse all ~10k genes without running `prepare_study()`. | ~484 MB download | Download `2327-processed.tar.gz` from the [`demo-data-v1`](10.6084/m9.figshare.33324843) release, untar into `data/2327/`, then `run_app("data/2327/2327.scminer.h5")`. |
